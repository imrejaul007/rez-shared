...
exports.paymentStatusToOrderPayment = paymentStatusToOrderPayment;
 ...
 */
function paymentStatusToOrderPayment(status) {
    return PAYMENT_TO_ORDER_STATUS[status] ?? null;
}
exports.default = { normalizeOrderStatus, normalizePaymentStatus, paymentStatusToOrderPayment };
