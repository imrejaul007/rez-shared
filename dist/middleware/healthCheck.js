 ...
 */
function createHealthCheckRouter(deps) {
        ...
        try {
            ...
            if (deps.redis) {
                ...
                try {
                    ...
                    status.errors?.push(`Redis error: ${err.message}`);
                    status.status = 'degraded';
                }
            }
 ...
 */
function attachHealthChecks(app, deps) {
